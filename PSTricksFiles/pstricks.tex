...
\def\psgetCMYKvalues#1#2#3#4#5;{\psgetCMYKvalues@i#5;}
\def\psgetCMYKvalues@i#1,#2,#3,#4;{#1 #2 #3 #4}

\def\psgetRGBvalues#1#2#3#4#5;{\psgetRGBvalues@i#5;}
\def\psgetRGBvalues@i#1,#2,#3;{#1 #2 #3}
