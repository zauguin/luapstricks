...
%    rectstroke 
%    (\jobname.psaux) (w) file /CoorFile exch def
%    (\\def\\pscoor{\string\() CoorFile exch writestring
%    XMIN 20 string cvs CoorFile exch writestring
%    (pt, ) CoorFile exch writestring
%    YMIN 20 string cvs CoorFile exch writestring
%    (pt\string\)\string\() CoorFile exch writestring
%    XMAX XMIN sub 20 string cvs CoorFile exch writestring
%    (pt, ) CoorFile exch writestring
%    YMAX YMIN sub 20 string cvs CoorFile exch writestring
