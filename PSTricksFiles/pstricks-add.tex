...
\def\ps@lympicRing(#1)#2{%
  \rput(#1){%
	...
	\pscircle[linewidth=0.05,linecolor=white](0,0){1.525}%
	\pscircle[linewidth=0.05,linecolor=white](0,0){1.225}}}
\def\ps@lympicArc(#1)#2#3#4{%
  \rput(#1){%
	\psarc[linewidth=0.25,linecolor=#2](0,0){1.375}{#3}{#4}%
	\psarc[linewidth=0.05,linecolor=white](0,0){1.525}{#3}{#4}%
	\psarc[linewidth=0.05,linecolor=white](0,0){1.225}{#3}{#4}}}
\def\psOlympicRings{\pst@object{psOlympicRings}}
\def\psOlympicRings@i(#1){%
  \pst@killglue
  \begingroup
  \addbefore@par{dimen=inner,psscale=1}%  
  \use@par
  \rput(#1){%
