...
\def\pst@AutoBoxFill{%
  ...
  \begingroup
    ...
    % \pstVerb{[matrix currentmatrix aload stack cleartomark \pst@dict /Box [ \luaPSTbox\hbox{%
    \pstVerb{\pst@dict /Box [ /gsave cvx /currentpoint cvx /translate cvx \luaPSTbox\hbox{%
        \ifx\PstTiling\@undefined
        \else
